...
#ifdef _WIN32
    pu.wstrToRef(ref, cmdline.get().size() >= 2 ? cmdline.get()[1] : L("main.ssz"));
#else
    pu.wstrToRef(ref, cmdline.get().size() >= 2 ? cmdline.get()[1] : u"main.ssz");
#endif
